    ...
    describe("CLASSic Threshold Enforcement with Logging", () => {
        it("should throw ValidationError and log warning for accuracy violation", () => {
            ...
            try {
                ...
                expect(validationError.validationFailures).toContainEqual(expect.stringContaining("Accuracy"));
            }
        });
        it("should throw ValidationError and log for latency violation", () => {
            ...
            try {
                ...
                expect(validationError.validationFailures).toContainEqual(expect.stringContaining("Latency"));
            }
        });
        it("should throw ValidationError and log for cost violation", () => {
            ...
            try {
                ...
                expect(validationError.validationFailures).toContainEqual(expect.stringContaining("Cost"));
            }
        });
...
//# sourceMappingURL=validation-logging.test.js.map