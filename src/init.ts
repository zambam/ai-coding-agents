...
`;
    ...
    if (options.writeStorage && orm !== 'none') {
      ...
      if (fs.existsSync(storagePath) && !options.force) {
        console.warn('Storage file exists at server/agent-storage.ts. Use --force to overwrite.');
        result.instructions.push('\nStorage file already exists. Use --force to overwrite.');
      } else {
...
// TODO: Update the db import path below to match your project structure
`;
