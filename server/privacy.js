...
export function hasConsent(userId, type) {
...
export function createPIIRedactionMiddleware(config = {}) {
...
export function createGDPRRouter(storage) {
    ...
    router.post("/consent/:userId", (req, res) => {
    ...
    router.delete("/consent/:userId", (req, res) => {
    ...
    router.get("/export/:userId", async (req, res) => {
        try {
            ...
            if (format === "json") {
                res.json(sanitizePayload(exportData));
            }
            else {
    ...
    router.get("/retention/policy", (_req, res) => {
        res.json({
